						...
						<div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
							<div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
								...
								<p className="leading-normal text-2xl mb-8">
									{data.site.siteMetadata.title} - a simple landing page styled with{' '}
									<a className="text-gray-800 font-bold underline" href="https://tailwindcss.com/">
										Tailwind CSS
									</a>{' '}
									 and generated by{' '}
									<a className="text-gray-800 font-bold underline" href="https://www.gatsbyjs.org/">
										GatsbyJS
									</a>
								</p>
							...
							<div className="flex flex-wrap">
								<div className="w-5/6 sm:w-1/2 p-6">
									...
									<p className="text-gray-600 mb-8">
										...
										build blazing fast websites and apps.<br />
										<br />
										Images from:{' '}
								...
								<div className="w-full sm:w-1/2 p-6 mt-6">
									<div className="align-middle">
										...
										<p className="text-gray-600 mb-8">
											...
											you all of the building blocks you need to build bespoke designs without any
											annoying opinionated styles you have to fight to override.<br />
											<br />
											Images from:{' '}
											<a className="text-orange-500 underline" href="https://undraw.co/">
												undraw.co
								...
								<div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
									...
									>
										...
										<p className="text-gray-800 text-base px-6 mb-5">
											Why Gatsby? Gatsby is a static PWA (Progressive Web App) generator. Gatsby
							...
							<div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
								<div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
									<a href="#" className="flex flex-wrap no-underline hover:no-underline">
										...
										<p className="text-gray-800 text-base px-6 mb-5">
											The source code is released under a license in which the copyright holder
